...
void VPinball::GetMyPath()
{
   ...
   *(szEnd + 1) = '\0'; // Get rid of exe name
#elif __ANDROID__
   string szStoragePath = string() + SDL_AndroidGetInternalStoragePath() + PATH_SEPARATOR_CHAR;
   ...
   MultiByteToWideCharNull(CP_ACP, 0, szPath, -1, wzPath, MAX_PATH);
   m_wzMyPath = wzPath;
}
