	...
	switch(dispIdMember) {
		...
		case 0x60020000: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&res) = VT_DISPATCH;
				hres = Add((IUnknown*)&var0, (ICompositeAction**)&V_DISPATCH(&res));
				VariantClear(&var0);
			}
			break;
		}
	...
	switch(dispIdMember) {
		...
		case 0x60020001: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&res) = VT_UNKNOWN;
				hres = Delayed(V_R4(&var0), (IUnknown*)&var1, &V_UNKNOWN(&res));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x60020004: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&res) = VT_UNKNOWN;
				hres = Repeat((IUnknown*)&var0, V_I4(&var1), &V_UNKNOWN(&res));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x60020009: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantCopyInd(&var0, &pDispParams->rgvarg[--index]);
				V_VT(&res) = VT_UNKNOWN;
				hres = AddChild((IUnknown*)&var0, &V_UNKNOWN(&res));
				VariantClear(&var0);
			}
			break;
		}
		case 0x6002000a: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantCopyInd(&var0, &pDispParams->rgvarg[--index]);
				V_VT(&res) = VT_UNKNOWN;
				hres = RemoveChild((IUnknown*)&var0, &V_UNKNOWN(&res));
				VariantClear(&var0);
			}
			break;
		}
	...
	switch(dispIdMember) {
		...
		case 0x60020026: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantCopyInd(&var0, &pDispParams->rgvarg[--index]);
				hres = RemoveActor((IUnknown*)&var0);
				VariantClear(&var0);
			}
			break;
		}
	...
	switch(dispIdMember) {
		...
		case 0x6002001b: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantCopyInd(&var0, &pDispParams->rgvarg[--index]);
				hres = putref_Bitmap((_Bitmap*)&var0);
				VariantClear(&var0);
			}
			break;
		}
	...
	switch(dispIdMember) {
		...
		case 0x6002001f: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				V_VT(&var0) = VT_EMPTY;
				VariantCopyInd(&var0, &pDispParams->rgvarg[--index]);
				hres = putref_Font((IUnknown*)&var0);
				VariantClear(&var0);
			}
			break;
		}
	...
	switch(dispIdMember) {
		...
		case 0x6002001f: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&res) = VT_DISPATCH;
				hres = NewLabel(V_BSTR(&var0), (IUnknown*)&var1, V_BSTR(&var2), (ILabelActor**)&V_DISPATCH(&res));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
