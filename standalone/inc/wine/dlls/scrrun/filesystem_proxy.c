                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("drive_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("drivecoll_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("textstream_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("file_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("filesys_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("foldercoll_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	if (hres == S_OK) {
		...
		printf("folder_Invoke: dispId=%d (0x%08x), wFlags=%d, hres=%d\n", dispIdMember, dispIdMember, wFlags, hres);
	}
	return hres;
}