/*** Autogenerated by WIDL 8.1 from include/oleidl.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IOleWindow_ContextSensitiveHelp(IOleWindow* This,BOOL fEnterMode) {
...
static __WIDL_INLINE HRESULT IOleInPlaceObject_ContextSensitiveHelp(IOleInPlaceObject* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceObject methods ***/
...
static __WIDL_INLINE HRESULT IOleInPlaceUIWindow_ContextSensitiveHelp(IOleInPlaceUIWindow* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceUIWindow methods ***/
...
static __WIDL_INLINE HRESULT IOleInPlaceFrame_ContextSensitiveHelp(IOleInPlaceFrame* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceUIWindow methods ***/
...
static __WIDL_INLINE HRESULT IOleInPlaceFrame_EnableModeless(IOleInPlaceFrame* This,BOOL fEnable) {
...
static __WIDL_INLINE HRESULT IOleInPlaceActiveObject_ContextSensitiveHelp(IOleInPlaceActiveObject* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceActiveObject methods ***/
...
static __WIDL_INLINE HRESULT IOleInPlaceActiveObject_OnFrameWindowActivate(IOleInPlaceActiveObject* This,BOOL fActivate) {
    return This->lpVtbl->OnFrameWindowActivate(This,fActivate);
}
static __WIDL_INLINE HRESULT IOleInPlaceActiveObject_OnDocWindowActivate(IOleInPlaceActiveObject* This,BOOL fActivate) {
    return This->lpVtbl->OnDocWindowActivate(This,fActivate);
}
static __WIDL_INLINE HRESULT IOleInPlaceActiveObject_ResizeBorder(IOleInPlaceActiveObject* This,LPCRECT prcBorder,IOleInPlaceUIWindow *pUIWindow,BOOL fFrameWindow) {
    return This->lpVtbl->ResizeBorder(This,prcBorder,pUIWindow,fFrameWindow);
}
static __WIDL_INLINE HRESULT IOleInPlaceActiveObject_EnableModeless(IOleInPlaceActiveObject* This,BOOL fEnable) {
    return This->lpVtbl->EnableModeless(This,fEnable);
}
#endif
#endif
...
static __WIDL_INLINE HRESULT IOleInPlaceSite_ContextSensitiveHelp(IOleInPlaceSite* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
/*** IOleInPlaceSite methods ***/
...
static __WIDL_INLINE HRESULT IOleInPlaceSite_Scroll(IOleInPlaceSite* This,SIZE scrollExtent) {
    return This->lpVtbl->Scroll(This,scrollExtent);
}
static __WIDL_INLINE HRESULT IOleInPlaceSite_OnUIDeactivate(IOleInPlaceSite* This,BOOL fUndoable) {
...
static __WIDL_INLINE HRESULT IOleContainer_LockContainer(IOleContainer* This,BOOL fLock) {
...
static __WIDL_INLINE HRESULT IOleItemContainer_LockContainer(IOleItemContainer* This,BOOL fLock) {
    return This->lpVtbl->LockContainer(This,fLock);
}
/*** IOleItemContainer methods ***/
...
static __WIDL_INLINE HRESULT IOleClientSite_OnShowWindow(IOleClientSite* This,BOOL fShow) {
...
static __WIDL_INLINE HRESULT IOleCache_SetData(IOleCache* This,FORMATETC *pformatetc,STGMEDIUM *pmedium,BOOL fRelease) {
...
static __WIDL_INLINE HRESULT IOleCache2_SetData(IOleCache2* This,FORMATETC *pformatetc,STGMEDIUM *pmedium,BOOL fRelease) {
    return This->lpVtbl->SetData(This,pformatetc,pmedium,fRelease);
}
/*** IOleCache2 methods ***/
...
static __WIDL_INLINE HRESULT IOleObject_InitFromData(IOleObject* This,IDataObject *pDataObject,BOOL fCreation,DWORD dwReserved) {
...
/*** IViewObject methods ***/
static __WIDL_INLINE HRESULT IViewObject_Draw(IViewObject* This,DWORD dwDrawAspect,LONG lindex,void *pvAspect,DVTARGETDEVICE *ptd,HDC hdcTargetDev,HDC hdcDraw,LPCRECTL lprcBounds,LPCRECTL lprcWBounds,BOOL (STDMETHODCALLTYPE *pfnContinue)(ULONG_PTR dwContinue),ULONG_PTR dwContinue) {
...
/*** IViewObject methods ***/
static __WIDL_INLINE HRESULT IViewObject2_Draw(IViewObject2* This,DWORD dwDrawAspect,LONG lindex,void *pvAspect,DVTARGETDEVICE *ptd,HDC hdcTargetDev,HDC hdcDraw,LPCRECTL lprcBounds,LPCRECTL lprcWBounds,BOOL (STDMETHODCALLTYPE *pfnContinue)(ULONG_PTR dwContinue),ULONG_PTR dwContinue) {
    return This->lpVtbl->Draw(This,dwDrawAspect,lindex,pvAspect,ptd,hdcTargetDev,hdcDraw,lprcBounds,lprcWBounds,pfnContinue,dwContinue);
}
...
/*** IDropSource methods ***/
static __WIDL_INLINE HRESULT IDropSource_QueryContinueDrag(IDropSource* This,BOOL fEscapePressed,DWORD grfKeyState) {
...
/*** IDropSourceNotify methods ***/
static __WIDL_INLINE HRESULT IDropSourceNotify_DragTargetEnter(IDropSourceNotify* This,HWND hwnd) {
    return This->lpVtbl->DragTargetEnter(This,hwnd);
}
static __WIDL_INLINE HRESULT IDropSourceNotify_DragTargetLeave(IDropSourceNotify* This) {
