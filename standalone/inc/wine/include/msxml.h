/*** Autogenerated by WIDL 8.1 from include/msxml.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IXMLDSOControl_get_JavaDSOCompatible(IXMLDSOControl* This,BOOL *fJavaDSOCompatible) {
    return This->lpVtbl->get_JavaDSOCompatible(This,fJavaDSOCompatible);
}
static __WIDL_INLINE HRESULT IXMLDSOControl_put_JavaDSOCompatible(IXMLDSOControl* This,BOOL fJavaDSOCompatible) {
