...
STDMETHODIMP VPinMAMERom::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"Rom");
		return S_OK;
	}
	return E_NOTIMPL;
}
...
STDMETHODIMP VPinMAMERoms::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"Roms");
		return S_OK;
	}
	return E_NOTIMPL;
}
...
STDMETHODIMP VPinMAMEGameSettings::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"GameSettings");
		return S_OK;
	}
	return E_NOTIMPL;
}
...
STDMETHODIMP VPinMAMEGame::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"Game");
		return S_OK;
	}
	return E_NOTIMPL;
}
...
STDMETHODIMP VPinMAMEGames::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"Games");
		return S_OK;
	}
	return E_NOTIMPL;
}
...
STDMETHODIMP VPinMAMEControllerSettings::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"ControllerSettings");
		return S_OK;
	}
	return E_NOTIMPL;
}
...
STDMETHODIMP VPinMAMEController::GetDocumentation(INT index, BSTR *pBstrName, BSTR *pBstrDocString, DWORD *pdwHelpContext, BSTR *pBstrHelpFile) {
	if (index == MEMBERID_NIL) {
		*pBstrName = SysAllocString(L"Controller");
		return S_OK;
	}
	return E_NOTIMPL;
}